...
## The deepTools ** computeMatrix scale-regions** command calculates scores to represent the reads mapping to specified regions of the genome across different files. 
